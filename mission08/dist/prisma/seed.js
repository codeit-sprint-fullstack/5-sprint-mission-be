...
async function main() {
    ...
    const postData = [
        {
            title: "오늘 날씨 정말 좋네요!",
            content: "하늘이 너무 맑고 기분도 상쾌한 하루예요. 다들 좋은 하루 보내세요!",
            author: "맑은하늘",
            likes: 15,
            comments: [
        ...
        {
            title: "좋은 책 추천해 주세요",
            content: "최근에 읽을만한 책 찾고 있어요. 감동적이거나 생각할 거리가 많은 책 추천 부탁드려요!",
            author: "책덕후",
            likes: 21,
            comments: [
                {
        ...
        {
            title: "운동 시작했어요!",
            content: "헬스장 등록하고 3일째인데 벌써 근육통이.. 운동 루틴 추천받아요!",
            author: "운동초보",
            likes: 30,
        },
        {
        ...
        },
        {
            ...
            content: "여러분은 아침형인가요, 저녁형인가요? 어떤 게 더 좋은 것 같아요?",
            author: "야행성",
            likes: 16,
            comments: [
                {
