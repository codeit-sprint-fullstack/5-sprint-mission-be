...
const createProductFavorite: ApiSignature = async (req, res) => {
  ...
  const response: ProductResponse = await favoriteService.createProductFavorite(
    "PRODUCT",
    productId,
    authInfo!
  );
...
const deleteProductFavorite: ApiSignature = async (req, res) => {
  ...
  const response: ProductResponse = await favoriteService.deleteProductFavorite(
    "PRODUCT",
    productId,
    authInfo!
  );
...
const createArticleFavorite: ApiSignature = async (req, res) => {
  ...
  const response = await favoriteService.createArticleFavorite(
    "ARTICLE",
    articleId,
    authInfo!
  );
...
const deleteArticleFavorite: ApiSignature = async (req, res) => {
  ...
  const response = await favoriteService.deleteArticleFavorite(
    "ARTICLE",
    articleId,
    authInfo!
  );
